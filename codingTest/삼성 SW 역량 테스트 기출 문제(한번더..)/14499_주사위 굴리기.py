...
# 이 지도의 위에 주사위가 하나 놓여져 있으며, 지도의 좌표는 (r, c)로 나타내며, 
# r는 북쪽으로부터 떨어진 칸의 개수, c는 서쪽으로부터 떨어진 칸의 개수
...
# 주사위를 놓은 곳의 좌표 x, y(0 ≤ x ≤ N-1, 0 ≤ y ≤ M-1),  명령의 개수 K (1 ≤ K ≤ 1,000)
...
for i in command :
    ...
    if graph[nx][ny] == 0 :
        graph[nx][ny] = dice[5]
    # 칸이 0 아니면 칸 번호를 주사위 바닥에 복사 하고 칸은 0
    else :
        dice[5] = graph[nx][ny]
        graph[nx][ny]= 0
